(function () {
  ...
  const HEART_IMAGE = frames.heart;
  ...
  const FIRE_ENTER_CPS = 12;
  const FIRE_EXIT_CPS = 9;
  const FIRE_HOLD_MS = 4
  5000;
  ...
  function grantReward() {
    ...
    el.className = 'reward-heart';
    el.src = HEART_IMAGE;
    el.alt = 'heart';
    el.style.left = hamsterCenter() + 'px';
    el.style.bottom = 16 + hamsterEl.clientHeight + 'px';
